...
bool PN532::readPassiveTargetID(uint8_t cardbaudrate, uint8_t *uid, uint8_t *uidLength, uint16_t timeout)
{
    ...
    */
    ...
    // Remember this target's number so inDataExchange() (ISO-DEP / Type-4) can
    // address it. Stock readPassiveTargetID omits this, leaving inListedTag at
    // 0, which makes every subsequent inDataExchange fail. (Long-standing
    // Adafruit/elechouse PN532 bug.)
